...
define(['dataService'], function (dataService) {
  ...
  function commenterDirective($timeout, dataService) {
    return {
      restrict: 'E',
        ...
        scope.$watch('child.name', function (newUserName) {
          if (newUserName) {
            ...
            timeout = $timeout(function () {
              dataService.fetchUsers(newUserName)
  ...
  commenterDirective.$inject = ['$timeout', 'dataService'];
  return commenterDirective;
});
